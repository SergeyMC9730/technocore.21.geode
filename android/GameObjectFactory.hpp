...
class GameObjectFactory {
 protected:
  ...
  public:
 	tl::optional<container_t> fetch(unsigned int uuid);
 	tl::optional<container_t> fetch(GameObject* obj);

 	tl::optional<generator_t> fetchGenerator(unsigned int object_id);
